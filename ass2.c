...
* Input: None
* Output: None
* Function Operation: get's a number x from the user and print a square
*                     with side of  size 2x+1 with diagonals and special characters
*                     for corners and the middle
**********************************************************************************/
    int drawSize;
...
* Input: None
* Output: None
* Function Operation: the function gets a sequence of characters from the user and
*                     print if the length is odd or even
**********************************************************************************/
    char evenCheck;
    printf("Enter text: ");
    scanf(" %c", &evenCheck);
...
* Input: None
* Output: None
* Function Operation: the function gets a sequence of letters from the user and
*                     checking the relation between the letters.
**********************************************************************************/
    ...
    while (secondLetter != '\n') {
        ...
        if (isValid && ((secondLetter >= 'a') && (secondLetter <= 'z')) &&
...
* Input: None
* Output: None
* Function Operation: the function gets a reversed number in base 16 and print its
*                     decimal value
**********************************************************************************/
...
* Input: None
* Output: None
* Function Operation: the function gets a base and a reversed number in the same
*                     base from the user and prints its decimal value.
**********************************************************************************/
...
* Input: None
* Output: None
* Function Operation: the function gets an integer and print all the active bits
*                     in his signed binary value
**********************************************************************************/
